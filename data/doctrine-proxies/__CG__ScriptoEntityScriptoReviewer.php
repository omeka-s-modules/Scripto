 ...
 */
class ScriptoReviewer extends \Scripto\Entity\ScriptoReviewer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'scriptoProject'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScriptoReviewer $proxy) {
