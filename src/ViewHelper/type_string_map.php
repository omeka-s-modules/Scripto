...
return [
    ...
    'Primary media' => [ // @translate
        ...
        'section' => 'Primary section', // @translate
    ...
    'Approved medias' => [ // @translate
        ...
        'section' => 'Approved sections', // @translate
    ...
    'Media count' => [ // @translate
        ...
        'section' => 'Section count', // @translate
    ...
    'Total media count' => [ // @translate
        ...
        'section' => 'Total section count', // @translate
    ...
    'Is approved media count' => [ // @translate
        ...
        'section' => 'Is approved section count', // @translate
    ...
    'Is completed media count' => [ // @translate
        ...
        'section' => 'Is completed section count', // @translate
    ...
    'Is in progress media count' => [ // @translate
        ...
        'section' => 'Is in progress section count', // @translate
    ...
    'Is edited after approved media count' => [ // @translate
        ...
        'section' => 'Is edited after approved section count', // @translate
    ...
    'Is edited after imported media count' => [ // @translate
        ...
        'section' => 'Is edited after imported section count', // @translate
    ...
    'Is synced after imported media count' => [ // @translate
        ...
        'section' => 'Is synced after imported section count', // @translate
    ...
    'Select media' => [ // @translate
        ...
        'section' => 'Select section', // @translate
    ...
    'No Scripto media found' => [ // @translate
        ...
        'section' => 'No Scripto sections found', // @translate
    ...
    'Scripto: Media' => [ // @translate
        ...
        'section' => 'Scripto: Section', // @translate
    ...
    'Mark media as not complete' => [ // @translate
        ...
        'section' => 'Mark section as not complete', // @translate
    ...
    'Mark media as complete' => [ // @translate
        ...
        'section' => 'Mark section as complete', // @translate
    ...
    'Mark media as not approved' => [ // @translate
        ...
        'section' => 'Mark section as not approved', // @translate
    ...
    'Mark media as approved' => [ // @translate
        ...
        'section' => 'Mark section as approved', // @translate
    ...
    'Scripto media metadata' => [ // @translate
        ...
        'section' => 'Scripto section metadata', // @translate
    ...
    'Batch edit medias' => [ // @translate
        ...
        'section' => 'Batch edit sections', // @translate
    ...
    'Batch edit all medias' => [ // @translate
        ...
        'section' => 'Batch edit all sections', // @translate
    ...
    'Affected medias' => [ // @translate
        ...
        'section' => 'Affected sections', // @translate
    ...
    'You are editing the following %s medias' => [ // @translate
        ...
        'section' => 'You are editing the following %s sections', // @translate
    ...
    'You are editing %s medias' => [ // @translate
        ...
        'section' => 'You are editing %s sections', // @translate
    ...
    'This Scripto media has no revisions.' => [ // @translate
        ...
        'section' => 'This Scripto section has no revisions.', // @translate
    ...
    'Review media' => [ // @translate
        ...
        'section' => 'Review section', // @translate
