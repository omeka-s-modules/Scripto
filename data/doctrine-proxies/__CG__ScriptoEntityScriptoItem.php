 ...
 */
class ScriptoItem extends \Scripto\Entity\ScriptoItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'scriptoProject', 'item', 'synced', 'edited', 'scriptoMedia'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScriptoItem $proxy) {
